...
#define GA10CHECK '\\'+'G'+'A'+'1'+'0'+'.'+'E'+'X'+'E'
...
char *gf1="Copyright (C) GoldFish Good Friend 1995 All right reserved\n"
                "GoldFish Assembler version 1.0 by GoldFish Good Friends\n";

char *gf2="ga10 [-option(s)] source [binary] [list]filenames\n"
                "-lxxx  labelnumber set   -1  1pass stop in error\n"
                "-exxx  equnumber set     -u  user open filename\n";

char *gf3="GoldFish Assembler version 1.0";
...
char l_binarycode[] =
{
        0x9f,0xf0,0xac,0xad,0xe2,0xe0,0xe0,0xe1,0xe1,0xc4,0x8d,0xc5
};
...
int f_initiation(int _argc,char *_argv[])
{
        ...
        if(a!=GA10CHECK) f_error(SYSERR,16);
